...
export const PIE_COLORS = [
    ...
    '#34d399', '#fb923c', '#38bdf8', '#e879f9', '#94a3b8', 
    '#fbbf24', '#6366f1'
];

export const TABS = [
    '📋 Cartera', '🔔 Alertas', '💰 Dividendos', '📝 Transacciones', 
    '📊 Gráficos', '🎯 Objetivos', '📐 Valoración', '🧾 Renta', 
    '🔭 Radar', '🔬 Análisis 360'
];
...
export const SECTORS = [
    ...
    'Consumo Defensivo', 'Energía', 'Materiales Básicos', 'Industria', 
    'Utilities', 'Inmobiliario', 'Comunicaciones'
];
...
export const MODULES = 'incomeStatementHistory,cashflowStatementHistory,balanceSheetHistory,defaultKeyStatistics,financialData';

export const TS_ANNUAL = [
...
export const FUND_PROXIES = QS_PROXIES;

export const BATCH_QUOTE_PROXIES = [
...
// Ticker por región para el Radar
export const RADAR_TICKERS = {
    'España': [
        ...
        'IDR.MC', 'ROVI.MC', 'UNI.MC', 'FAE.MC', 'BAMI.MC', 'GCO.MC'
    ],
    'EE.UU.': [
...
// Inicializar Global con todos los tickers
...
export const RADAR_REGIONS = [
    'Todos', 'España', 'Europa', 'EE.UU.', 'Reino Unido', 'Asia', 'Global'
];

export const RADAR_CURRENCIES = [
    'Todas', 'EUR', 'USD', 'GBP', 'CAD', 'AUD', 'JPY'
];

export const RADAR_PERSISTED_KEYS = {
    region: 'km_radar_region',
    sector: 'km_radar_sector',
    currency: 'km_radar_currency',
    hideOwned: 'km_radar_hideOwned'
};